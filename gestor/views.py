...
from core.models import Cliente, Contato, ClienteItem
from core.forms import ClienteForm, ContatoForm, ClienteItemForm
from core.views import usuario_list, usuario_create, usuario_update, usuario_toggle_status
from django.contrib.auth.decorators import login_required
...
def contato_create(request, cliente_id):
    ...
    return render(request, 'gestor/contato_form.html', {
        'form': form, 
        'cliente': cliente
    })
...
def contato_delete(request, pk):
    ...
    return render(request, 'gestor/contato_confirm_delete.html', {
        'contato': contato,
        'cliente': cliente
    })
